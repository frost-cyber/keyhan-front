<template>
  <div>
    ...
    <form @submit.prevent="checkVerifyCode">
      <vs-input class="contactform verify mt-6" label="کد تایید"  placeholder="کد تایید" type="text" v-model="verifyCode" size="large"/>
...
<style>
.verify .vs-inputx.vs-input--input.large{
 text-align: center;
  letter-spacing: 10px;
}
</style>
